...
<image redraw="yes" offsetXPC="2.5" offsetYPC="4" widthPC="8" heightPC="11"><?php echo $DIR_SCRIPT_ROOT; ?>image/youtubeu.jpg</image>
...
foreach($videos as $video) {
    ...
    $link=$HTTP_SCRIPT_ROOT."xLiveCZ/modules/links/yt1.php?file=".$link;
    //$link=str_replace("&","&amp;",$link);
