...
<?php
$URL = ("http://ifktv.cz/archiv.html");



if (($html = openpage($URL) ) != FALSE) {

echo "<channel>\n<title>IFK Třinecko</title>";
...
//parsovani polozek
    ...
    <script>
    showIdle();
    url=geturl("http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/ifk_link.php?file='.$link.'");
    annotation=url;
    cancelIdle();
    playItemURL(url, 10);
    </script>
