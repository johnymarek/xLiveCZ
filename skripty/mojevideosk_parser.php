...
$videos = explode('<div class="vid_small">', $html);
...
//parsovani polozek
    ...
    $t1 = explode('<p class="vid_title">', $video);
    $t2 = explode('</p>', $t1[1]);
    $titulek = $t2[0];
	...
	$linktofinal = "http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/mojevideosk_link.php?link=".$link;
