...
echo "<channel>\n<title>Hejbejse TV</title>";
	...
	$t1 = explode('<div id="programs">', $html);
    $t2 = explode('<div class="clear">', $t1[1]);
    $pom = $t2[0];
...
//parsovani polozek
    ...
    $titulek = $t2[0];
			...
			<item>
				<title>".$titulek."</title>
				<link>http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/hejbejse_parser.php?query=0,".$link."</link>
			</item>\n";
    	}
