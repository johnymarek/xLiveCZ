...
$videos = explode('<div class="nettv-show-item">', $html);
...
//parsovani polozek
    ...
    $t1 = explode('<a class="nettv-show-link" href="', $video);
    $t2 = explode('"', $t1[1]);
    $link = $t2[0];
    ...
    $nahled = $t2[0];
			...
			<item>
				<title>".$titulek."</title>
				<link>http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/ocko_parser.php?query=0,".$link."</link>
				<image>".$nahled."</image>
			</item>\n";
    	}
