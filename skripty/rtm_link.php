...
function openpage ($rowurl) {
	...
	$be->addHeaderLine("Referer", "http://www.tvrtm.cz/");   // volani odkud jsi na stranku prisel. pouzij nejakou jejich vychozi stranku.
...
>
 	...
 	<text align="center" offsetXPC="0" offsetYPC="0" widthPC="100" heightPC="20" fontSize="30" backgroundColor="10:105:150" foregroundColor="100:200:255">
  	...
  	<text  redraw="yes" align="center" offsetXPC="0" offsetYPC="90" widthPC="100" heightPC="8" fontSize="17" backgroundColor="10:105:150" foregroundColor="100:200:255">
		...
		<image  redraw="yes" offsetXPC=61 offsetYPC=25 widthPC=35 heightPC=50>
...
if($query) {
   ...
   $page = $queryArr[0];
   $nazev = $queryArr[1];}
$URL = "http://www.tvrtm.cz/televize.php?page=ivysilani&str=".$page."&kategorie=".$nazev;

echo "<channel>\n<title>RTM Liberec</title>";
...
if (($html = openpage($URL) ) != FALSE) {
    ...
    $t2 = explode('"', $t1[1]);
    $link = "http://www.tvrtm.cz/".$t2[0];
	
	$t1 = explode('<img src="', $video);
    $t2 = explode('"', $t1[1]);
    $nahled = "http://www.tvrtm.cz/".$t2[0];
	...
	$linktofinal = "http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/rtm_final.php?link=".$link;
