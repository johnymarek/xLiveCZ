...
<onClick>playItemURL("http://127.0.0.1/cgi-bin/play.cgi?type=onehd&amp;url=<?php echo $server; ?>/onehdhd&amp;w=http://www.livehd.tv/player/player.swf&amp;p=http://www.livehd.tv/&amp;y=onehdhd&amp;t=<?php echo $token; ?>", 10);</onClick>
<mediaDisplay name="threePartsView"/>
</item>

<item>
<title>OneHD - Live! Jazz</title>
<onClick>playItemURL("http://127.0.0.1/cgi-bin/play.cgi?type=onehd&amp;url=<?php echo $server; ?>/jazzhd&amp;w=http://www.livehd.tv/player/player.swf&amp;p=http://www.livehd.tv/&amp;y=jazzhd&amp;t=<?php echo $token; ?>", 10);</onClick>
...
<onClick>playItemURL("http://127.0.0.1/cgi-bin/play.cgi?type=onehd&amp;url=<?php echo $server; ?>/classicshd&amp;w=http://www.livehd.tv/player/player.swf&amp;p=http://www.livehd.tv/&amp;y=classicshd&amp;t=<?php echo $token; ?>", 10);</onClick>
...
<onClick>playItemURL("http://127.0.0.1/cgi-bin/play.cgi?type=onehd&amp;url=<?php echo $server; ?>/dancehd&amp;w=http://www.livehd.tv/player/player.swf&amp;p=http://www.livehd.tv/&amp;y=dancehd&amp;t=<?php echo $token; ?>", 10);</onClick>
<mediaDisplay name="threePartsView"/>
</item>

<item>
<title>OneHD - Live! Rock</title>
<onClick>playItemURL("http://127.0.0.1/cgi-bin/play.cgi?type=onehd&amp;url=<?php echo $server; ?>/rockhd&amp;w=http://www.livehd.tv/player/player.swf&amp;p=http://www.livehd.tv/&amp;y=rockhd&amp;t=<?php echo $token; ?>", 10);</onClick>
...
<onClick>playItemURL("http://127.0.0.1/cgi-bin/play.cgi?type=onehd&amp;url=<?php echo $server; ?>/pophd&amp;w=http://www.livehd.tv/player/player.swf&amp;p=http://www.livehd.tv/&amp;y=pophd&amp;t=<?php echo $token; ?>", 10);</onClick>
