...
$URL = ("http://csmatalent.joj.sk/csmt3-video/csmt3-video-vystupenia/strana-".$page.".html");
...
<?php }
    ...
    $t2 = explode('<div class="b b-ad ad-300x300">', $t1[1]);
    $pom = $t2[0];

	//nastaveni bloku pro vyhledani pole polozek
$videos = explode('<li class="i', $pom);
