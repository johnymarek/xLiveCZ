...
//print_r($videoid);
	...
	$time= sprintf ("%d:%2.1f",$cas, $mins, $secs);		
	...
	$S = "http://www.joj.sk/fileadmin/templates/swf/JojPlayer.swf?no_cache=176146";
	$C = "1935";
	$N = $prep;
	$T = ("rtmp://".$prep);
	$find = ".flv";
    ...
    $ItemsOut .= "
			<item>
				<title>".$titulek." - kvalita: ".$quality."</title>
				<link>http://".$prep."/".$Y."</link>
				<enclosure type=\"video/flv\" url=\"http://".$prep."/".$Y."\"/>
				<description>Délka videa: ".$mins.":".$secs."</description>
				<media:thumbnail url=\"".$nahled."\" />
			</item>\n";	
	}}}
