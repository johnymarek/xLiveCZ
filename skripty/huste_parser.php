...
$url = $sThisFile."?file=".$link.",".$disk.",".($page-1);
?>
...
<?php }
	...
	$videos = explode('<li id="clip', $html);
	...
	$linktofinal = "http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/huste_parser_link.php?file=".$odkaz.",".$disk;
