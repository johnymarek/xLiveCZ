...
$ItemsOut .= "<channel>\n<title>JOJ Archiv</title>";
	...
	//$t1 = explode('relationId=', $html);
    //$t2 = explode('&', $t1[1]);
    //$id = $t2[0];

    $t1 = explode('videoId=', $html);
    $t2 = explode('&amp', $t1[1]);
    $link1 = "sefka.joj.sk/services/Video.php?clip=".$t2[0];
	...
	$S = "http://www.sefka.sk/fileadmin/templates/swf/csmt_player.swf?no_cache=171307";
	$C = "1935";
	$N = $prep;
	$T = ("rtmp://".$prep);
	$Y = $odkaz;
