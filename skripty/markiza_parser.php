...
//parsovani polozek
    ...
    $t2 = explode('"', $t1[1]);
    $link = "http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/markiza_parser_link.php?file=http://video.markiza.sk".$t2[0];
