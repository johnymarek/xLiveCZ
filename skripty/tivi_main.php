...
$t1 = explode('<strong class="hide">Video kanály</strong><ul class="reset level_2">', $html);
    $t2 = explode('<div class="cb">', $t1[1]);
    $pom = $t2[0];
...
//parsovani polozek
	...
	IF ($titulek!="Sexi telá"){
			$ItemsOut .= "
			<item>
				<title>".$titulek."</title>
				<link>http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/tivi.php?query=1,".$link."</link>
			</item>\n";
    	}}
