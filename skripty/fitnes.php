...
$URL = "http://www.fitnesstv.cz/cviceni";
...
echo "<channel>\n<title>Fitness TV</title>";
	...
	$t1 = explode('<li class=" odd first-child">', $html);
    $t2 = explode('<div id="menu-categories-decoration"></div>', $t1[1]);
    $pom = $t2[0];
	
	
$videos = explode('<a ', $pom);
...
//parsovani polozek
    ...
    $t2 = explode('"', $t1[1]);
    $link = "http://www.fitnesstv.cz".$t2[0];
    ...
    $titulek = $t2[0];
			...
			<item>
				<title>".$titulek."</title>
				<link>http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME'])."/fitnes_parser.php?query=".$link."</link>
			</item>\n";
    	}
